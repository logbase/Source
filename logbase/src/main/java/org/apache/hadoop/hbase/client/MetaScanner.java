...
public class MetaScanner {
  ...
  //wangsheng hack here 2013-5-14
    //System.out.println("tableName = #"+ (tableName == null ? "null" : new String(tableName))+"#");
    //System.out.println("metaTableName = #"+ (metaTableName == null ? "null" : new String(metaTableName))+"#");
    //System.out.println("row = #"+ (row == null ? "null" : new String(row))+"#");
    ...
    //wangsheng
    //System.out.println("MetaScanner startRow = " + new String(startRow));
    ...
    do {
      ...
      try {
        callable.setCaching(rows);
          ...
          //for (Result rr : rrs){
        //	  System.out.println("rrs = "+new String(rr.toString()));
          //}
          //System.out.println("==");
